...
module "permission_sets" {
  source = "git::https://github.com/cloudposse/terraform-aws-sso.git//modules/permission-sets?ref=0.8.0"

  permission_sets = concat(var.permission_sets, local.tf_admin_permission_sets)
}

module "account_assignments" {
  source = "git::https://github.com/cloudposse/terraform-aws-sso.git//modules/account-assignments?ref=0.8.0"
