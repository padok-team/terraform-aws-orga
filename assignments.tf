...
# locals {
#   assignment_map = {
#     for a in local.accounts_assignements_flatten :
...
#   group_list = toset([for mapping in local.accounts_assignements_flatten : mapping.principal_name if mapping.principal_type == "GROUP"])
#   user_list  = toset([for mapping in local.accounts_assignements_flatten : mapping.principal_name if mapping.principal_type == "USER"])
# }
